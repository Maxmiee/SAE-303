---
title: "Comment la crise sanitaire a-t-elle impacté les aéroports parisiens ?"
...
```{r}
acf(traffic_2000_2019,lag.max = 30, main= "Autocorrélogramme de la série jusqu'à" )
```
...
legend("bottomleft",legend = "Tendance",col="blue",lty=1)
...
plot(notend , main= "Série traffic aérien des aéroports parisiens jusqu'en 2019 sans tendance", xlab="Année",ylab ="")
...
plot (notend, xlab ="Annees", ylab =" ", main =" Saisonnalite estimée sur la série traffic aérien sans tendance")
...
```{r}
plot(traffic_2000_2019, xlim = c(2000,2020 + N/12),ylim=c(4500,max(pred_tend_sais)),main = "Prévisions du taffic aérien après 2020 dans les aéroports parisiens",xlab="Année" ,ylab = "Nombre de voyageurs (en milliers)")
...
plot (notend_c, xlab ="Annees", ylab =" ", main ="Saisonnalite estimée sur la série traffic aérien sans tendance")
...
plot(ts_traffic, xlim = c(2000,2023 + C19/12),main = "Prévisions sans covid",xlab="Année" ,ylab = "Nombre de voyageurs (en milliers)")
...
```{r}
plot(ts_traffic, xlim = c(2000,2023 + C19/12),main = "Comparaison des prévisions",xlab="Année" ,ylab = "Nombre de voyageurs (en milliers)")
lines(pred_tend_sais_c, lwd = 2,col = "green")
lines(pred_tend_sais, lwd = 2,col = "red")
legend("bottomleft",legend = c("Prévisions sans covid","Prévisions de la reprise après covid"),col=c("red","green"),lty=1)
```
